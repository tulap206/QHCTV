...
export const SEED_DATA = {
  ...moduleFields,
  collaborators: [
    { id: 1, ma_so: 'CTV-001', nickname: 'Anh Bảy Chợ Đông Ba', address: 'Chợ Đông Ba, Phú Hòa, Huế', phone: '0905111222', managing_officer: 'Phan Lê Tự Lập', lat: 16.4682, lng: 107.5878, coverage_radius: 400, ghi_chu: 'Địa bàn hoạt động xung quanh cổng chợ' },
    { id: 2, ma_so: 'CTV-002', nickname: 'Chú Sáu Vỹ Dạ', address: 'Phường Vỹ Dạ, TP Huế', phone: '0905333444', managing_officer: 'Dương Văn Thành', lat: 16.4695, lng: 107.6042, coverage_radius: 600, ghi_chu: 'Theo dõi các tụ điểm karaoke ven sông' },
    { id: 3, ma_so: 'CTV-003', nickname: 'Chị Năm An Cựu', address: 'Cầu An Cựu, TP Huế', phone: '0905555666', managing_officer: 'Trương Tuấn Long', lat: 16.4528, lng: 107.5955, coverage_radius: 300, ghi_chu: 'Địa bàn ga Huế và bến xe phía Nam' }
  ]
};
