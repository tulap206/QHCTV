...
export const SEED_DATA = {
  ...moduleFields,
  collaborators: [
    { id: 1, ma_so: 'CTV-001', nickname: 'Anh Bảy Chợ Đông Ba', address: 'Chợ Đông Ba, Phú Hòa, Huế', phone: '0905111222', managing_officer: 'Phan Lê Tự Lập', lat: 16.4682, lng: 107.5878, coverage_radius: 400, competence: 'Xuất sắc', khu_vuc_hoat_dong: 'Chợ Đông Ba và phụ cận', giao_nhiem_vu: 'Nắm tình hình trộm cắp và các băng nhóm hoạt động bảo kê tại chợ Đông Ba', ket_qua: 'Đang thực hiện tốt, báo tin kịp thời về 2 vụ móc túi', created_date: '2026-01-15', ghi_chu: 'Địa bàn hoạt động xung quanh cổng chợ' },
    { id: 2, ma_so: 'CTV-002', nickname: 'Chú Sáu Vỹ Dạ', address: 'Phường Vỹ Dạ, TP Huế', phone: '0905333444', managing_officer: 'Dương Văn Thành', lat: 16.4695, lng: 107.6042, coverage_radius: 600, competence: 'Tốt', khu_vuc_hoat_dong: 'Phường Vỹ Dạ và cồn Hến', giao_nhiem_vu: 'Giám sát hoạt động của các tụ điểm ăn chơi về đêm, hát karaoke ven sông', ket_qua: 'Chưa có thông tin mới do đang tạm ngưng', created_date: '2026-02-10', ghi_chu: 'Theo dõi các tụ điểm karaoke ven sông' },
    { id: 3, ma_so: 'CTV-003', nickname: 'Chị Năm An Cựu', address: 'Cầu An Cựu, TP Huế', phone: '0905555666', managing_officer: 'Trương Tuấn Long', lat: 16.4528, lng: 107.5955, coverage_radius: 300, competence: 'Khá', khu_vuc_hoat_dong: 'Khu vực Ga Huế và Bến xe Phía Nam', giao_nhiem_vu: 'Theo dõi luồng di cư, hoạt động của đối tượng nghi vấn đi tàu/xe khách', ket_qua: 'Đã cung cấp thông tin 1 đối tượng nghi vấn vận chuyển hàng cấm', created_date: '2026-03-05', ghi_chu: 'Địa bàn ga Huế và bến xe phía Nam' }
  ]
};
